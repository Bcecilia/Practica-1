...
public class Salida {
	byte num;
	String error, et, co, op, nombre_i, nombre_e, modos;
	public Main m = new Main();
	public String nombre = m.NombreArchivo();
	
	public Salida(byte n, String e, String c, String o, String mo){
		num = n;
		et = e;
		co = c;
		op = o;
	...
	public void CrearArchivoInst() throws IOException{//recibe el nombre del archivo
		...
		pw.println("Linea     Etiqueta\tCodop    Operando\tModos de direccionamiento");
		pw.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		pw.flush();
		pw.close();
